		...
		return (
			<div className="sideBar">
				...
				{this.props.data.map(function(element, i) {
					return (
						<a key={i} href={"#" + element.name} > {element.name}</a>
					)
				})}
			</div>
		)
		...
		return (
			<div id="About-Section">
				...
				<div id="About">
					...
					<h1><u>About Me</u></h1>
					<p>I am a <b>Mechatronics Engineering</b> student at the University of Waterloo. I <b>started programming in 2012</b> and am skilled in many areas such as <b>full stack, mobile, desktop and firmware development</b>. I use a variety of programming languages and I'm always learning more. Also, I have completed a number of projects involving mechanical and electrical design. I am always looking for opportunities to expand my knowledge in all areas. However, currently I would like to focus on <b>mechanical and electrical design</b> as these two areas fascinate me the most. Currently I am doing this by working on woodworking and PCB design projects. I enjoy playing a variety of sports and outdoor activities. I am a passionate, enthusiastic, problem solver with excellent collaborative and interpersonal skills.</p>
					<div id="Links">
...
class ContentElements extends React.Component {
	render() {
		...
		return (
			<div className="contentElement" id={this.props.name}>
